rm(list = ls())
library(mvtnorm)
setwd('/Users/lihao/Documents/FinancialDatamining/homework/week9/assignment_09/MATLAB/R')
...
plot(X[, 1], X[, 2], pch = 16, col = 'black', xlab = "X1",
     ylab = 'X2', main = 'Outliers and normal examples',
     cex = 0.2)
par(new = TRUE)
plot(X[outliers, 1],X[outliers, 2], pch = 4, col = 'red', 
     xlab = '', ylab = '',
     cex = 0.5, add = TRUE)
